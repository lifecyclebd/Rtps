            ...
            <div class="navbar-inner">
                ...
                <div class="btn-group pull-right">
                    <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                        <i class="glyphicon glyphicon-user"></i><span class="hidden-sm hidden-xs"> <?php echo $this->session->userdata('admin_name'); ?></span>
        ...
        <div class="ch-container">
                    ...
                    <div class="sidebar-nav">
                        <div class="nav-canvas">
                            ...
                            <ul class="nav nav-pills nav-stacked main-menu">
                                ...
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/catagory"><i class="glyphicon glyphicon-tasks"></i><span> Catagory</span></a>
                                </li>
                                
                                
                                <?php $status=$this->session->userdata('admin_status');
                                    if($status ==1){
                                ?>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/admin"><i class="glyphicon glyphicon-user"></i><span>Add admin</span></a></li>
                                ...
                                <li><a class="ajax-link" href="typography.html"><i class="glyphicon glyphicon-font"></i><span> Add Division</span></a>
                                </li>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_division"><i class="glyphicon glyphicon-user"></i><span> Manage Division</span></a>
                                </li>
                                <li><a class="ajax-link" href="typography.html"><i class="glyphicon glyphicon-font"></i><span> Add District</span></a>
                                </li>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_district"><i class="glyphicon glyphicon-font"></i><span> Manage District</span></a>
                                </li>
            ...
            <div class="row">
                <div class="col-md-9 col-lg-9 col-xs-9 hidden-xs">
                    <script async src="//pagead2.googlesyndication.com/pagead/<?php echo base_url(); ?>js/adsbygoogle.js"></script>
                    <!-- Charisma Demo 2 -->
